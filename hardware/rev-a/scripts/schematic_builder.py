...
class Sheet:
    ...
    def component(self, lib_id, ref, value, x,y,nets=None, rotation=0, footprint=None, mpn=None, fields=None, label_stub=5.08):
        ...
        c=e('symbol',e('lib_id',lib_id),e('at',x,y,rotation),e('unit',1),e('in_bom',S('no' if ref.startswith('#') else 'yes')),e('on_board',S('no' if ref.startswith('#') else 'yes')),e('dnp',S('no')),e('uuid',pid))
        ...
        for p in defs:
            ...
            if net is not None:
                ...
                la=(angle+180)%360
                across = net in {'GND','+3V3','VBAT_PROTECTED','PWR_GOOD','BAT_SENSE','RP_USB_DM','RP_USB_DP','USB_VBUS_SENSE'} or net.startswith(('A_','B_','C_')) and not net.endswith('_C5')
    ...
    def save(self):
        head=e('kicad_sch',e('version',20250114),e('generator',S('eeschema')),e('generator_version','10.0'),e('uuid',self.id),e('paper','A3'),
          e('title_block',e('title',self.title),e('date','2026-09-23'),e('rev','A0 DRAFT'),e('company','FarmMesh Node'),e('comment',1,'Engineering review only - NOT FOR FABRICATION'),e('comment',2,'1S Li-ion battery input; no on-board charger')),
