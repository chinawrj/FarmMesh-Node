...
**A1 硬件原型 — 产品目标、PCB 与首板验证计划**

[English](README.md) | 简体中文

[项目概述](#项目概述) · [A1 硬件](#a1-硬件原型) · [功能与指标](#关键功能与性能目标) · [整体架构](#整体架构) · [内部接口](#候选内部接口) · [无线研究](#无线研究状态) · [待决策事项](#待决策事项) · [阶段规划](#阶段规划) · [联系与参与](#联系与参与) · [参考资料](#参考资料)
...
项目按**先硬件、后软件**的顺序推进。**A1 已包含八页原理图和四层 PCB**；投样放行状态以 [RELEASE.md](hardware/rev-a/RELEASE.md) 为准。固件、接口时序与实物性能验证尚未完成。覆盖、用户吞吐、终端容量、功耗和板内链路持续性能均未经实测。
...
| 阶段 | 范围 | 状态 |
| --- | --- | --- |
| 1 | 硬件接口与架构确认 | 审阅中；接口实现尚未验证 |
| 2 | 原理图与 PCB | A1 原理图及 PCB；放行门槛见 RELEASE.md |
